...
urlpatterns = [
    ...
    path('notifications/<int:notification_id>/mark-as-read/', MarkNotificationAsReadView.as_view(),
         name='mark-as-read'),
    ...
    path('bids/<int:bid_id>/', BidDetailView.as_view(), name='bid-detail'), ##seee the bid details
    ...
    path('my-quotes/', MyBidsView.as_view(), name='accessor_bids'),
